...
class TimeSeriesDecomposer:
    ...
    def make_series_stationary(self, df, target_col):
        ...
        for order_d in [1,2,3]:
            ...
            df_stationary[new_target_col] = df_stationary[target_col].diff().fillna(0)
    ...
    def decompose_time_series(self, df, target_column):
        ...
        decomposer = STL(df[target_column], seasonal=7)  # Ajusta el valor 'seasonal' según la periodicidad de los datos
